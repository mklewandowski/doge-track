    ...
    <div>
      ...
      <Stack spacing={{ xs: 1, sm: 2, md: 4 }} margin={1} sx={{ width: "auto" }}>
        <Card elevation={2} sx={{ outline: "1px solid black", backgroundColor: "white", color: "black", width: "100%" }}>
          <CardContent sx={{ width: "100%", padding: "12px 8px 0px 8px"}}>
            <Box sx={{display: "flex", flexDirection: "row", alignItems: "flex-start", backgroundColor: "beige", padding: "8px"}}>
              <img src={waffles} width="50%" style={{border: "3px solid black", borderRadius: "6px", transform: "rotate(2deg)", maxWidth: "200px"}} />
            </Box>
        ...
        <Card elevation={2} sx={{ outline: "1px solid black", backgroundColor: "white", color: "black", width: "100%" }}>
          <CardContent sx={{ width: "100%", padding: "12px 8px 0px 8px"}}>
            <Box sx={{display: "flex", flexDirection: "row", alignItems: "flex-start", backgroundColor: "beige", padding: "8px"}}>
              <img src={waffles2} width="50%" style={{border: "3px solid black", borderRadius: "6px", transform: "rotate(-2deg)", maxWidth: "200px"}} />
            </Box>
            <Box sx={{display: "flex", flexDirection: "row", alignItems: "center", marginTop: "10px"}}>
        ...
        <Card elevation={2} sx={{ outline: "1px solid black", backgroundColor: "white", color: "black", width: "100%" }}>
          <CardContent sx={{ width: "100%", padding: "12px 8px 0px 8px"}}>
            <Box sx={{display: "flex", flexDirection: "row", alignItems: "flex-start", backgroundColor: "beige", padding: "8px"}}>
              <img src={waffles3} width="50%" style={{border: "3px solid black", borderRadius: "6px", transform: "rotate(2deg)", maxWidth: "200px"}} />
            </Box>
            <Box sx={{display: "flex", flexDirection: "row", alignItems: "center", marginTop: "10px"}}>
        ...
        <Card elevation={2} sx={{ outline: "1px solid black", backgroundColor: "white", color: "black", width: "100%" }}>
          <CardContent sx={{ width: "100%", padding: "12px 8px 4px 8px"}}>
            <Box margin={1} sx={{display: "flex", flexDirection: "row", alignItems: "flex-end"}}>
              <img src={dogeLogo} style={{maxWidth: "50px"}} />
              <Typography variant={"body1"} component={"div"} m={1} sx={{fontWeight: "400"}}>
                YOUR Dogecoins are worth
              </Typography>
            </Box>
        ...
        <Card elevation={2} sx={{ outline: "1px solid black", backgroundColor: "white", color: "black", width: "100%" }}>
          <CardContent sx={{ width: "100%", padding: "12px 8px 0px 8px"}}>
            <Box sx={{display: "flex", flexDirection: "row", alignItems: "flex-start", backgroundColor: "beige", padding: "8px"}}>
              <img src={waffles4} width="50%" style={{border: "3px solid black", borderRadius: "6px", transform: "rotate(-2deg)", maxWidth: "200px"}} />
            </Box>
            <Box sx={{display: "flex", flexDirection: "row", alignItems: "center", marginTop: "10px"}}>
